...
|---|---|---|
| [[Varian Shipping Report]] | Active / Automation phase | Daily Excel/VBA report with HTML email; exploring full automation |
| [[AI CNC Research]] | Delivered | Excel + PDF + PowerPoint delivered to leadership |
...
- Mersen has Power Automate via M365 — no additional cost for Phase 1
- Server infrastructure exists (K/M/L drives) — IT ticket needed for Phase 2
- Goal: fully hands-off daily report pipeline requiring zero manual steps
